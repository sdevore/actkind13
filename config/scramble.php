...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'These are the client api endpoints for the application. You can use the Try It feature to test the endpoints directly from the documentation.',
    ],
