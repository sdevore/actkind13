...
<body class="min-h-screen bg-gradient-to-r from-emerald-400/10 via-green-200/10 to-teal-400/10 font-sans antialiased selection:bg-[#FF2D20] selection:text-white dark:from-emerald-900/80 dark:via-green-800/90 dark:to-teal-800/90 dark:text-slate-200">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            @can('invite users')
                <flux:navbar.item
                    ...
                    :current="request()->routeIs('invitations.index')"
                    wire:navigate
                >
                    {{ __('Invitations') }}
                </flux:navbar.item>
            ...
            <flux:navbar.item
                icon="hand-heart"
                :href="route('acts.mine')"
                :current="request()->routeIs('acts.mine')"
                wire:navigate
            >
