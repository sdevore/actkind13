    ...
    <section class="m-6 mb-2 border-b-2 border-neutral-500/50 text-center text-slate-700 dark:border-neutral-500/50 dark:text-slate-200">
        ...
        @guest()
            <p class="mx-auto w-3/4 text-left lg:w-1/2">
                ...
                give people a place to share these acts with others. I believe that when you can see the kind acts of
                others, you may be inspired to take a moment and be intentionally kind to someone, a person you know, or
                a person you see who could use lift up, or someone you may never see.
            </p>
